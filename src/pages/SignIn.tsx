      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Sign in to your account to continue your safe travels
          </p>
        </div>
          ...
          <Card className="bg-emergency/5 border-emergency/20">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="font-medium text-emergency">Emergency Access</span>
              </div>
              <p className="text-sm text-muted-foreground mb-3">
                Need immediate help without signing in?
              </p>
              <Button 
                variant="outline" 
                size="sm" 
